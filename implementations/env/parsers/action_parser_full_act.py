...
class ActionParser():
    ...
    def _parse(self, game_state: GameState, player: str, raw_actions):
        ...
        if game_state.real_env_steps < 0:
            if my_turn:
                ...
                x = spawn['location'] // EnvParam.map_size
                y = spawn['location'] % EnvParam.map_size
        ...
        for unit_id, robot in robots.items():
            ...
            if action is not None \
                ...
                if unit_map[new_pos[0], new_pos[1]] != -1:
                    ...
                    new_pos = robot.pos
                unit_map[new_pos[0], new_pos[1]] = int(unit_id[len('unit_'):])
    ...
    def get_valid_actions(game_state: GameState, player_id: int):
        ...
        # # DO_NOTHING: empty cell can also do nothing
        ...
        # # DO_NOTHING: empty cell can also do nothing
        # valid_actions["unit_act"]["act_type"][UnitActType.DO_NOTHING, :, :] = True
